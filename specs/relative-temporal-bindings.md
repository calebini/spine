...
The current schema-11 runtime advertises this complete family only with matching migration, schemas, fixtures, behavioral tests, command handling, bounded scheduler reconciliation, readback, and attempt-start freshness enforcement.
