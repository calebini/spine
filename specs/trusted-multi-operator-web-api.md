...
Related ratified contract: [independent-activity-reads.md](independent-activity-reads.md)
defines a separate, not-yet-implemented web read projection for authorized activities with unavailable
